 ...
 */
export async function compareScreenshots(prev, next, threshold = 30) {
    ...
    const prevData = prevImg.bitmap.data;
    const nextData = nextImg.bitmap.data;
 ...
 */
export async function cropRegion(pngBuffer, region, padding = 20) {
    const image = await Jimp.read(pngBuffer);
